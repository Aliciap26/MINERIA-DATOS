...
#Filters 
#we filter the information (data) that we want to obtain, in this case the genre and the production studies.
...
# Graphs
#We designate the value x the gender data.
#Y percentage
...
# Graphs/colors date
#We define the color of the points and the size.
GGgraph +
  xlab("Genre") +
  ylab("Groos % US") +
